                        ...
                        <c:when test="${not empty sessionScope.cart && not empty sessionScope.cart.items}">
                            <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
                                ...
                                <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="cart" method="POST" style="display: inline;">
                                                            ...
                                                            <c:set var="isDuck"
                                                                value="${fn:trim(item.product.name) eq 'Vịt quay Quảng Đông'}" />
                                                            <c:set var="step" value="${isDuck ? 0.5 : 1}" />
                                                            <c:set var="min" value="${isDuck ? 0.5 : 1}" />

                                                            <input type="number" name="quantity"
                                                                value="${item.quantity}" min="${min}" step="${step}"
                                    ...
                                    <a href="menu" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Tiếp Tục
                                        Mua
                                        Hàng</a>
                                </div>
